    ...
    Public Function loadMySqlToArray(sqlString As String, numberDB As Int16) As Object(,)
        ...
        For Each row In dSet.Tables(0).Rows
            For i = 0 To dSet.Tables(0).Columns.Count - 1
                Dim name = row.Item(i).GetType.ToString
                If row.Item(i).GetType.ToString = "System.DateTime" Then
                    dateValue = row.Item(i)
                    result(i, rowCount) = dateValue.ToShortDateString
                Else
