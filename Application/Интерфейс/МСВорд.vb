Module МСВорд
    ...
    End Sub
    Sub addParagraph(DOK As Object, номерАбзаца As Integer, текст As String, Шрифт As String, РазмерШрифта As Integer, Выравнивание As Double, ОтступКраснаяСтрока As Double, ОтступПередАбзацем As Double, МежстрочныйИнтервал As Double, Жирный As Boolean)
