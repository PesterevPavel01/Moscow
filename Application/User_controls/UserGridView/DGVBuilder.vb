...
Public Class DGVBuilder
    ...
    Public Sub redactorOpen()
        ...
        If Not userDGV.flagUpdate Then redactor_setWhiteColor()

        userDGV.SplitContainer_main.Panel2Collapsed = False

        If Not userDGV.redactor_autoUpdate Then redactor_firstControl_focus()

        userDGV.flagRedactorOpen = True

    End Sub

    Public Sub redactorClose()

        If userDGV.keyboardEvents.dictionaryFlag(userDGV.comboBox_first_element.Name) Or userDGV.keyboardEvents.dictionaryFlag(userDGV.comboBox_second_element.Name) Then

            userDGV.comboBox_first_element.my_ComboBox.DroppedDown = False
            userDGV.comboBox_second_element.my_ComboBox.DroppedDown = False
            Return
        ...
        userDGV.flagRedactorOpen = False
