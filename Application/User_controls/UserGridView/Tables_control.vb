...
Public Class Tables_control
    ...
    End Sub
    '------------------------------Если сохраняем на S
    Public Sub table_enterDown(sender As Object, e As KeyEventArgs)
        If Not SplitContainer_main.Panel2Collapsed Then
            secondElement_enterDown(e)
        Else
            If name_table = "group_list" Then
                dataGridTables_CellDoubleClick(sender, e)
                e.Handled = True
    ...
    Public Sub secondElement_enterPress(e As KeyPressEventArgs)
        ...
        Dim transitFlag As Boolean = keyboardEvents.userDGV.redactor_autoUpdate
        readFromRedactor()
        ...
        keyboardEvents.userDGV.redactor_autoUpdate = False
        load_table()
        keyboardEvents.userDGV.redactor_autoUpdate = transitFlag
    ...
    Public Sub secondElement_enterDown(e As KeyPressEventArgs)
        Dim transitFlag As Boolean = keyboardEvents.userDGV.redactor_autoUpdate
        readFromRedactor()
        If flagUpdate Then
            tableRedactor.updateRow()
    ...
    Public Sub secondElement_enterDown(e As KeyEventArgs)
        Dim transitFlag As Boolean = keyboardEvents.userDGV.redactor_autoUpdate
        readFromRedactor()
        If flagUpdate Then
            tableRedactor.updateRow()
