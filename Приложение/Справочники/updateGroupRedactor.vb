Module updateGroupRedactor
    ...
    'Sub update(НомерГруппы As String)
    ...
    '    РедакторГруппы.НоваяГруппаУровеньКвалификации.Text = GroupList.infoAboutGroup(21, 0)

    '    GroupList.gruppaData.number = GroupList.infoAboutGroup(1, 0)
    '    РедакторГруппы.НоваяГруппаНомер.Text = GroupList.infoAboutGroup(1, 0)

    '    GroupList.gruppaData.formaObuch = GroupList.infoAboutGroup(2, 0)
    '    РедакторГруппы.НоваяГруппаФормаОбучения.Text = GroupList.infoAboutGroup(2, 0)
    '    Try
    '        РедакторГруппы.НоваяГруппаДатаНачалаЗанятий.Value = GroupList.infoAboutGroup(3, 0)
    '    Catch ex As Exception

    '    End Try
    '    GroupList.gruppaData.dataNZ = GroupList.infoAboutGroup(3, 0)
    '    Try
    '        РедакторГруппы.НоваяГруппаКонецЗанятий.Value = GroupList.infoAboutGroup(4, 0)
    '    Catch ex As Exception
    ...
    '    РедакторГруппы.НоваяГруппаСпециальность.Text = GroupList.infoAboutGroup(5, 0)
    '    GroupList.gruppaData.specialnost = GroupList.infoAboutGroup(5, 0)

    '    РедакторГруппы.НоваяГруппаПрограмма.Text = GroupList.infoAboutGroup(6, 0)
    '    GroupList.gruppaData.programma = GroupList.infoAboutGroup(6, 0)

    '    If IsNumeric(GroupList.infoAboutGroup(37, 0)) Then
    '        РедакторГруппы.setProgKod(Convert.ToInt64(GroupList.infoAboutGroup(37, 0)))
    '    End If
    '    РедакторГруппы.setflagAllListProgs(False)

    '    РедакторГруппы.НоваяГруппаОтветственныйКуратор.Text = GroupList.infoAboutGroup(8, 0)
    '    GroupList.gruppaData.kurator = GroupList.infoAboutGroup(8, 0)
    '    РедакторГруппы.НоваягруппаОтветственныйЗаПрактику.Text = GroupList.infoAboutGroup(9, 0)
    '    GroupList.gruppaData.otvZaPraktiku = GroupList.infoAboutGroup(9, 0)
    '    РедакторГруппы.Модуль1.Text = GroupList.infoAboutGroup(11, 0)
    '    GroupList.gruppaData.modul1 = GroupList.infoAboutGroup(11, 0)
    '    РедакторГруппы.Модуль2.Text = GroupList.infoAboutGroup(12, 0)
    '    GroupList.gruppaData.modul2 = GroupList.infoAboutGroup(12, 0)
    '    РедакторГруппы.Модуль3.Text = GroupList.infoAboutGroup(13, 0)
    '    GroupList.gruppaData.modul3 = GroupList.infoAboutGroup(13, 0)
    '    РедакторГруппы.Модуль4.Text = GroupList.infoAboutGroup(14, 0)
    '    GroupList.gruppaData.modul4 = GroupList.infoAboutGroup(14, 0)
    '    РедакторГруппы.Модуль5.Text = GroupList.infoAboutGroup(15, 0)
    '    GroupList.gruppaData.modul5 = GroupList.infoAboutGroup(15, 0)
    '    РедакторГруппы.Модуль6.Text = GroupList.infoAboutGroup(16, 0)
    '    GroupList.gruppaData.modul6 = GroupList.infoAboutGroup(16, 0)
    '    РедакторГруппы.Модуль7.Text = GroupList.infoAboutGroup(17, 0)
    '    GroupList.gruppaData.modul7 = GroupList.infoAboutGroup(17, 0)
    '    РедакторГруппы.Модуль8.Text = GroupList.infoAboutGroup(18, 0)
    '    GroupList.gruppaData.modul8 = GroupList.infoAboutGroup(18, 0)
    '    РедакторГруппы.Модуль9.Text = GroupList.infoAboutGroup(19, 0)
    '    GroupList.gruppaData.modul9 = GroupList.infoAboutGroup(19, 0)
    '    РедакторГруппы.Модуль10.Text = GroupList.infoAboutGroup(20, 0)
    '    GroupList.gruppaData.modul10 = GroupList.infoAboutGroup(20, 0)
    '    РедакторГруппы.НоваяГруппаФинансирование.Text = GroupList.infoAboutGroup(22, 0)
    '    GroupList.gruppaData.financir = GroupList.infoAboutGroup(22, 0)

    '    If GroupList.infoAboutGroup(21, 0) = "повышение квалификации" Then

    '        РедакторГруппы.НомерУд.Text = GroupList.infoAboutGroup(24, 0)
    ...
    '        РедакторГруппы.РегНомерУд.Text = GroupList.infoAboutGroup(25, 0)
    ...
    '        Try
    '            РедакторГруппы.ДатаВыдачиУд.Value = GroupList.infoAboutGroup(26, 0)
    '        Catch ex As Exception
    '        End Try

    '    ElseIf (GroupList.infoAboutGroup(21, 0) = "профессиональная переподготовка") Then
    '        РедакторГруппы.НомерДиплома.Text = GroupList.infoAboutGroup(27, 0)
    ...
    '        РедакторГруппы.РегНомерДиплома.Text = GroupList.infoAboutGroup(28, 0)
    ...
    '        Try
    '            РедакторГруппы.ДатаВДиплома.Value = GroupList.infoAboutGroup(29, 0)
    '        Catch ex As Exception

    '        End Try

    '        РедакторГруппы.НомерПротоколаИА.Text = GroupList.infoAboutGroup(23, 0)
    ...
    '        РедакторГруппы.НомерСвид.Text = GroupList.infoAboutGroup(30, 0)
    ...
    '        РедакторГруппы.РегНомерСвид.Text = GroupList.infoAboutGroup(31, 0)
    ...
    '        Try
    '            РедакторГруппы.ДатаВСвид.Value = GroupList.infoAboutGroup(32, 0)
    '        Catch ex As Exception
    ...
    '    РедакторГруппы.Квалификация.Text = GroupList.infoAboutGroup(33, 0)
