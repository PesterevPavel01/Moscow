Module ДоверенностьПолученияБланковНаГруппу
    ...
    Sub ДоверенностьПолученияБланковНаГруппу()
        ...
        queryString = selectDover_slush(MainForm.prikazKodGroup)
        ...
        queryString = selectDoverKval(MainForm.prikazKodGroup)
        ...
        Вспомогательный.savePrikazBlank(ДокументВорд, MainForm.prikazKodGroup, ВидПриказа, ПутьККаталогуСРесурсами, "Доверенности")
        ...
        Вспомогательный.ЗаменитьТекстВОбластиДокументаВорд(ДокументВорд.Range, "$И.О.Ответств$", rotate(АСформироватьПриказ.Утверждает.Text), 2)
