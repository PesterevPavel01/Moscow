Module ДоверенностьПолученияБланковНаГруппу
    ...
    Sub ДоверенностьПолученияБланковНаГруппу()
        ...
        СтрокаЗапроса = selectDover_kval(ААОсновная.prikazKodGroup)
        ...
        'If Вспомогательный.СоздатьПапку(ПутьККаталогуСРесурсами & "Группы\Группа N" & АСформироватьПриказ.НомерГруппы.Text & "\Доверенности") Then
        '    Вспомогательный.сохранить(ДокументВорд, ВидПриказа, ПутьККаталогуСРесурсами & "Группы\Группа N" & АСформироватьПриказ.НомерГруппы.Text & "\Доверенности\")
        'Else
    ...
    Sub ДоверенностьПолученияБланковНаСлушателя(ЧекнутыеСлушатели As Object)
        ...
        For СчетчикСтрок = 0 To UBound(ЧекнутыеСлушатели, 2)
            ...
            'If Вспомогательный.СоздатьПапку(ПутьККаталогуСРесурсами & "Группы\Группа N" & АСформироватьПриказ.НомерГруппы.Text & "\Доверенности") Then
            '    Вспомогательный.сохранить(ДокументВорд, ВидПриказа, ПутьККаталогуСРесурсами & "Группы\Группа N" & АСформироватьПриказ.НомерГруппы.Text & "\Доверенности\")
            '    предупреждение.текст.Text = "Доверенности сохранены, Путь к каталогу:" & ПутьККаталогуСРесурсами & "Группы\Группа N" & АСформироватьПриказ.НомерГруппы.Text & "\Доверенности"
            'Else
            '    Вспомогательный.сохранить(ДокументВорд, ВидПриказа, ПутьККаталогуСРесурсами & "Группы\Нераспределенное\")
