Public Class ВедомостьПеднагрузка
    ...
    Private Sub loadTables()
        ...
        СтрокаЗапроса = "SELECT Преподаватель, Лекции, ПрактическиеЗанятия, СтимулирующиеЗанятия, Консультация, ПА, ИА FROM Педнагрузка WHERE Kod = " & kodGroup & " ORDER BY Преподаватель"
    ...
    Private Sub Сохранить_Click(sender As Object, e As EventArgs) Handles Сохранить.Click
        ...
        МассивИменИТипов(0, 0) = "Преподаватель"
        МассивИменИТипов(1, 0) = "String"

        МассивИменИТипов(0, 1) = "Лекции"
        МассивИменИТипов(1, 1) = "Double"
        МассивИменИТипов(0, 2) = "ПрактическиеЗанятия"
        МассивИменИТипов(1, 2) = "Double"
        МассивИменИТипов(0, 3) = "СтимулирующиеЗанятия"
        МассивИменИТипов(1, 3) = "Double"
        МассивИменИТипов(0, 4) = "Консультация"
        МассивИменИТипов(1, 4) = "Double"
        МассивИменИТипов(0, 5) = "ПА"
        МассивИменИТипов(1, 5) = "Double"
        МассивИменИТипов(0, 6) = "ИА"
        МассивИменИТипов(1, 6) = "Double"

        СохранитьЗначенияДатаГрид(ТаблицаВедомость, "Педнагрузка", Критерий, МассивИменИТипов, 0, 6)
    End Sub
