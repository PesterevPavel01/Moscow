Module Приказ_Практика
    Sub Приказ_Практика(ВидПриказа As String)
        ...
        queryString = loadListStudents(MainForm.orderIdGroup)
        ...
        _technical.replaceTextInWordApp(wordDoc.Range, "$РуководительППДолжность$", BuildOrder.ОтветственныйДолжность.Text, 2)
        _technical.replaceTextInWordApp(wordDoc.Range, "$РуководительПП$", BuildOrder.Ответственный.Text, 2)
