...
Module ПП_ПриложениеКДиплому
    ...
    Sub ПП_ПриложениеКДиплому(видПриказа As String)
        ...
        sqlQuery = prilDiplomLoadData(MainForm.prikazKodGroup)
        ...
        sqlQuery = selectMassForPrilDiplom(MainForm.prikazKodGroup)
        ...
        Вспомогательный.savePrikazBlank(ДокументВорд, MainForm.prikazKodGroup, видПриказа, ПутьККаталогуСРесурсами, "Приложение")
